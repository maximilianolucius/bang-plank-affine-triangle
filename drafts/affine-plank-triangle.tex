...
\address{Department of Mathematics, Faculty of Science, Islamic University of
Madinah, Madinah, Saudi Arabia}
\email{ialraddadi@iu.edu.sa}
\author{Maximiliano Lucius}
\address{Independent Researcher, CABA, Argentina}
\email{maximiliano.lucius@gmail.com}
\author{Hijaz Ahmad}
\address{Department of Mathematics, Faculty of Science, Islamic University of
Madinah, Madinah, Saudi Arabia; Operational Research Center in Healthcare,
Near East University, Near East Boulevard, PC: 99138 Nicosia/Mersin 10,
Turkey; Department of Mathematics, College of Science, Korea University,
145 Anam-ro, Seongbuk-gu, Seoul 02841, South Korea}
\email{hijazahmad@korea.ac.kr}
\author{Waleed Mohammed Abdelfattah}
\address{College of Engineering, University of Business and Technology,
Jeddah 23435, Saudi Arabia; Department of Engineering Mathematics and
Physics, Faculty of Engineering, Zagazig University, P.O. 44519, Egypt}
...
and only if the mid-level lines concur; for every concurrent \emph{cyclic}
...
some plank empty, and (iii) proper balanced. Case (i) is
Theorem~\ref{thm:extreme} ($\sum r\ge1$); case (ii) is
Theorem~\ref{thm:twodir} ($\sum r\ge1$, at most two non-parallel directions).
...
hardware) but at a scale ($812{,}651$ leaves) beyond hand verification. This is
