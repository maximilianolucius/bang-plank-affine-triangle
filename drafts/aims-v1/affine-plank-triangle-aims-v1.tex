...
The authors declare that they used Artificial Intelligence (AI) tools in the
preparation of this article.

\noindent AI tools used:
Claude (Anthropic), a large-language-model agent platform.

\noindent How were the AI tools used?
The tools were used in the exploration and drafting of proofs, in the design of
the branch-and-bound search underlying Theorem~\ref{thm:sandwichbang}, in the
preparation and language editing of the manuscript text, and in the preparation
of the ancillary code. All mathematical statements were reviewed and verified by
the authors; the computer-assisted certificate of Theorem~\ref{thm:sandwichbang}
is validated by an independent checker in exact rational arithmetic, as described
in Appendix~\ref{app:ancillary}.

\noindent Where in the article is the information located?
AI-assisted content may appear throughout the manuscript; the computer-assisted
step and its verification protocol are documented in \S\ref{sec:problems} and
Appendix~\ref{app:ancillary}. No AI tool was used to fabricate citations or
alter results.

The authors take full responsibility for the content, accuracy, integrity, and
