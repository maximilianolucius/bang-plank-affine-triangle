...
Alibaba Cloud service, Qwen 3.6 Plus.

\noindent How were the AI tools used?
The tool was used to assist with language editing, clarity, grammar correction,
and manuscript structure. The authors reviewed, edited, and verified all
AI-assisted content.

\noindent Where in the article is the information located?
AI-assisted edits may appear throughout the manuscript. No AI tool was used to
generate or modify core research data, fabricate citations, alter results, or
replace the authors' scientific judgment.
