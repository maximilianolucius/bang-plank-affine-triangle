...
\shortauthors{I. Alraddadi, M. Lucius, H. Ahmad, W. M. Abdelfattah}
...
Email: \texttt{maximiliano.lucius@gmail.com}}
...
\addr{\affilnum{6}}{Department of Engineering Mathematics and Physics, Faculty
...
The authors declare they have used Artificial Intelligence (AI) tools ---
large-language-model agents --- in the creation of this article: in the
exploration and drafting of proofs, in the design of the branch-and-bound search
underlying Theorem~\ref{thm:sandwichbang}, and in the preparation of the
manuscript text. All mathematical statements were verified by the authors; in
particular, the computer-assisted certificate of Theorem~\ref{thm:sandwichbang}
is validated by an independent checker, sharing no code with the search, in
exact rational arithmetic, as described in Appendix~\ref{app:ancillary}. The
authors are fully responsible for the content of the manuscript.
